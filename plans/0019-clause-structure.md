...
- Accent blue: tool voice and structure. The dashed amber marker with a
  panel background means outside the scored evidence (relabeled NOT
  SCORED by plan 0021); the shape keeps it a different species from the
  solid-border grade chips that share the amber hue. No other semantic
  color use.
