# Agentic-SDLC audit: ryanportfolio/AI-Firmware

**Overall: 68.6/100, Developing**

- Collected: 2026-07-18T18:46:39.728Z
- Head commit: `4f913e0416375e4a421cd96daec742f35ec7f786`
- Sample: 48 commits, 35 merged PRs
...
|-----------|-------|--------|-------|
| Agent attribution & provenance | 100/100 | 0.1 | 48/48 commits have clear provenance (linked account, bot identity, or co-author trailer). Agent-involved share is reported as context, not judged. |
| Recorded review coverage | 0/100 | 0.15 | 0/35 merged PRs received at least one review not authored by the PR author. |
| Recorded review catch rate | could not verify | 0.1 | Could not verify: no reviewed PRs in sample. |
| Human merge gate | 100/100 | 0.15 | 35/35 sampled merges were performed by a non-bot account. |
...
| Batch size | 100/100 | 0.1 | Median merged-PR diff size is 89 lines (additions+deletions). Small batches score higher. |
| Lead time (first commit → merge) | 100/100 | 0.05 | Median lead time from first PR commit to merge is 0.1h. |
| Plan-before-code evidence | 2.9/100 | 0.1 | 1/35 merged PRs reference a linked issue or plan document in the PR body. |
| Audit-trail completeness | 64.8/100 | 0.1 | Mean of: substantive PR description ≥120 chars (33/35), review recorded (0/35), CI checks recorded (35/35). |
...
- **Agent attribution & provenance**: commits_sampled=48, agent_involved_pct=35.4, commits_per_week=27
- **Recorded review coverage**: merged_prs=35, reviewed_prs=0
- **Human merge gate**: merges_with_known_merger=35, human_merges=35
- **CI test/eval gate**: workflow_files=1, prs_with_checks=35, pr_check_pass_rate_pct=100
- **Batch size**: median_diff_lines=89, p90_diff_lines=393
- **Lead time (first commit → merge)**: median_lead_time_hours=0.1, prs_measured=35
- **Plan-before-code evidence**: merged_prs=35, prs_with_plan_ref=1
- **Audit-trail completeness**: substantive_description_prs=33, review_recorded_prs=0, checks_recorded_prs=35
