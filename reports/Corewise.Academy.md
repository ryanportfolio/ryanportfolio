# Agentic-SDLC audit: ryanportfolio/Corewise.Academy

**Overall: 69/100, Developing**

- Collected: 2026-07-18T18:45:20.375Z
- Head commit: `7dba4905d1c76a77488c3bce4ea1464848f21b52`
- Sample: 260 commits, 50 merged PRs (truncated at collection limit)
...
|-----------|-------|--------|-------|
| Agent attribution & provenance | 100/100 | 0.1 | 260/260 commits have clear provenance (linked account, bot identity, or co-author trailer). Agent-involved share is reported as context, not judged. |
...
| Batch size | 100/100 | 0.1 | Median merged-PR diff size is 10 lines (additions+deletions). Small batches score higher. |
| Lead time (first commit → merge) | 100/100 | 0.05 | Median lead time from first PR commit to merge is 0.1h. |
| Plan-before-code evidence | 4/100 | 0.1 | 2/50 merged PRs reference a linked issue or plan document in the PR body. |
| Audit-trail completeness | 66.7/100 | 0.1 | Mean of: substantive PR description ≥120 chars (50/50), review recorded (0/50), CI checks recorded (50/50). |
...
- **Agent attribution & provenance**: commits_sampled=260, agent_involved_pct=54.2, commits_per_week=1065.8
- **Recorded review coverage**: merged_prs=50, reviewed_prs=0
- **Human merge gate**: merges_with_known_merger=50, human_merges=50
- **CI test/eval gate**: workflow_files=2, prs_with_checks=50, pr_check_pass_rate_pct=100
- **Batch size**: median_diff_lines=10, p90_diff_lines=183
- **Lead time (first commit → merge)**: median_lead_time_hours=0.1, prs_measured=50
- **Plan-before-code evidence**: merged_prs=50, prs_with_plan_ref=2
- **Audit-trail completeness**: substantive_description_prs=50, review_recorded_prs=0, checks_recorded_prs=50
