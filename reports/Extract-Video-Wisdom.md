# Agentic-SDLC audit: ryanportfolio/Extract-Video-Wisdom

**Overall: 55.7/100, Early**

- Collected: 2026-07-18T18:43:03.172Z
- Head commit: `44a4dbae2c981f75a653635bbed5e53ec3e90afc`
...
| Batch size | 100/100 | 0.1 | Median merged-PR diff size is 70.5 lines (additions+deletions). Small batches score higher. |
| Lead time (first commit → merge) | 100/100 | 0.05 | Median lead time from first PR commit to merge is 0.1h. |
| Plan-before-code evidence | 8/100 | 0.1 | 4/50 merged PRs reference a linked issue or plan document in the PR body. |
...
- **Agent attribution & provenance**: commits_sampled=300, agent_involved_pct=50.3, commits_per_week=84.7
...
- **Batch size**: median_diff_lines=70.5, p90_diff_lines=281
- **Lead time (first commit → merge)**: median_lead_time_hours=0.1, prs_measured=50
- **Plan-before-code evidence**: merged_prs=50, prs_with_plan_ref=4
