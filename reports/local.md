# Agentic-SDLC audit: ryanportfolio/local

**Overall: 71.6/100, Developing**

- Collected: 2026-07-18T18:47:20.519Z
- Head commit: `10798332f159b53105c5b18bdab6fb6fffbaec8b`
- Sample: 15 commits, 6 merged PRs
...
|-----------|-------|--------|-------|
| Agent attribution & provenance | 100/100 | 0.1 | 15/15 commits have clear provenance (linked account, bot identity, or co-author trailer). Agent-involved share is reported as context, not judged. |
| Recorded review coverage | 0/100 | 0.15 | 0/6 merged PRs received at least one review not authored by the PR author. |
| Recorded review catch rate | could not verify | 0.1 | Could not verify: no reviewed PRs in sample. |
| Human merge gate | 100/100 | 0.15 | 6/6 sampled merges were performed by a non-bot account. |
...
| Batch size | 100/100 | 0.1 | Median merged-PR diff size is 86 lines (additions+deletions). Small batches score higher. |
| Lead time (first commit → merge) | 100/100 | 0.05 | Median lead time from first PR commit to merge is 0.2h. |
| Plan-before-code evidence | 33.3/100 | 0.1 | 2/6 merged PRs reference a linked issue or plan document in the PR body. |
| Audit-trail completeness | 61.1/100 | 0.1 | Mean of: substantive PR description ≥120 chars (5/6), review recorded (0/6), CI checks recorded (6/6). |
...
- **Agent attribution & provenance**: commits_sampled=15, agent_involved_pct=40, commits_per_week=5.3
- **Recorded review coverage**: merged_prs=6, reviewed_prs=0
- **Human merge gate**: merges_with_known_merger=6, human_merges=6
- **CI test/eval gate**: workflow_files=1, prs_with_checks=6, pr_check_pass_rate_pct=100
- **Batch size**: median_diff_lines=86, p90_diff_lines=1418
- **Lead time (first commit → merge)**: median_lead_time_hours=0.2, prs_measured=6
- **Plan-before-code evidence**: merged_prs=6, prs_with_plan_ref=2
- **Audit-trail completeness**: substantive_description_prs=5, review_recorded_prs=0, checks_recorded_prs=6
