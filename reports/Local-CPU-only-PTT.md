# Agentic-SDLC audit: ryanportfolio/Local-CPU-only-PTT

**Overall: 64.9/100, Developing**

- Collected: 2026-07-18T18:47:14.268Z
- Head commit: `790cc51ac322573865fbd1d477f01e003109c564`
- Sample: 30 commits, 12 merged PRs
...
|-----------|-------|--------|-------|
| Agent attribution & provenance | 100/100 | 0.1 | 30/30 commits have clear provenance (linked account, bot identity, or co-author trailer). Agent-involved share is reported as context, not judged. |
| Recorded review coverage | 0/100 | 0.15 | 0/12 merged PRs received at least one review not authored by the PR author. |
| Recorded review catch rate | could not verify | 0.1 | Could not verify: no reviewed PRs in sample. |
| Human merge gate | 100/100 | 0.15 | 12/12 sampled merges were performed by a non-bot account. |
| CI test/eval gate | 100/100 | 0.15 | 2 workflow file(s) present (40pts). 100% of sampled merged PRs had all check runs passing at head (up to 60pts). |
| Batch size | 70/100 | 0.1 | Median merged-PR diff size is 606 lines (additions+deletions). Small batches score higher. |
| Lead time (first commit → merge) | 100/100 | 0.05 | Median lead time from first PR commit to merge is 0.1h. |
| Plan-before-code evidence | 0/100 | 0.1 | 0/12 merged PRs reference a linked issue or plan document in the PR body. |
| Audit-trail completeness | 63.9/100 | 0.1 | Mean of: substantive PR description ≥120 chars (11/12), review recorded (0/12), CI checks recorded (12/12). |
...
- **Agent attribution & provenance**: commits_sampled=30, agent_involved_pct=53.3, commits_per_week=36
- **Recorded review coverage**: merged_prs=12, reviewed_prs=0
- **Human merge gate**: merges_with_known_merger=12, human_merges=12
- **CI test/eval gate**: workflow_files=2, prs_with_checks=12, pr_check_pass_rate_pct=100
- **Batch size**: median_diff_lines=606, p90_diff_lines=28293
- **Lead time (first commit → merge)**: median_lead_time_hours=0.1, prs_measured=12
- **Plan-before-code evidence**: merged_prs=12, prs_with_plan_ref=0
- **Audit-trail completeness**: substantive_description_prs=11, review_recorded_prs=0, checks_recorded_prs=12
